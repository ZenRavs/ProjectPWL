...
?>
    <div class="row g-4 mb-3 me-1">
        <div class="col-sm-6 justify-content-start">
            <div class="row">
                <form class="col input-group" id="searchBox">
                    ...
                    <input type="text" class="form-control border-light" id="searchInput" placeholder="Search..." aria-label="Search" style="width: 250px;" required>
        ...
        <div class="col-sm-1 d-flex justify-content-center">
            <a type="button" href="data/scripts/reporting/mpdfLect.php" class="btn btn-dark">&#128462; Print</a>
        </div>
        <div class="col-sm-3">
    ...
    <table class="table table-dark table-hover">
        <thead">
            <tr>
                ...
                <th style="width: 200px;">NPP</th>
                <th style="width: 600px;">Name</th>
                <th class="text-center" style="width: 150px;">Homebase</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData(page, maxRow) {
                $("#tableBody").empty();
                $.ajax({
                    url: 'data/scripts/requestbase.php?req=fetchLecturers',
                    type: 'POST',
                    data: {
                        page: page,
                        maxRow: maxRow
            ...
            $('#searchBox').on('submit', function(e) {
                ...
                $("#pagination").empty();
                $.ajax({
                    url: 'data/scripts/requestbase.php?req=searchLecturer',
                    type: 'POST',
                    data: {
                        page: page,
            ...
            $('#tableBody').on('click', '#deleteBtn', function() {
                ...
                if (confirm("Are you sure to delete this row?")) {
                    $.ajax({
                        url: 'data/scripts/requestbase.php?req=deleteLecturer',
                        type: 'POST',
                        data: {
                            id: id,
                            page: page
