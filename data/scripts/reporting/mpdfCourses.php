...
while ($row = $result->fetch_assoc()) {
    $data .=
        '<tr>
            ...
            <td style="width: 50px; border: 1px solid black;">' . $row['code'] . '</td>
            <td style="width: 50px; border: 1px solid black;">' . $row['name'] . '</td>
            <td style="width: 50px; border: 1px solid black;">' . $row['type'] . '</td>
            <td style="width: 50px; border: 1px solid black;">' . $row['sks'] . '</td>
            <td style="width: 50px; border: 1px solid black;">' . $row['smt'] . '</td>
        </tr>';
    $i++;
}
$html = '
