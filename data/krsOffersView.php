...
?>
    <div class="row g-4 mb-3 me-1">
        <div class="col-sm-6 justify-content-start">
            <div class="row">
                <form class="col input-group" id="searchBox">
                    ...
                    <input type="text" class="form-control border-light" id="searchInput" placeholder="Search..." aria-label="Search" style="width: 200px;" required>
        ...
        <div class="col-sm-1 d-flex justify-content-center">
            <a type="button" href="data/scripts/reporting/mpdfKrsOffers.php" class="btn btn-dark">&#128462; Print</a>
        </div>
        <div class="col-sm-3">
    ...
    <table class="table table-dark table-bordered table-hover">
        <thead class="table-bordered">
            <tr>
                ...
                <th rowspan="2" class="text-center" style="width: 100px;">Group</th>
                <th colspan="3" class="text-center">Schedule 1</th>
                <th colspan="3" class="text-center">Schedule 2</th>
                <th rowspan="2" class="text-center" style="width: 100px;">Action</th>
            </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData(page, maxRow) {
                $("#tableBody").empty();
                $.ajax({
                    url: 'data/scripts/requestbase.php?req=fetchOffers',
                    type: 'POST',
                    data: {
                        page: page,
                        maxRow: maxRow
            ...
            $('#tableBody').on('click', '#editBtn', function() {
                var id = $(this).data('id');
                window.location.href = '?view=edit-krs-offer&req=update&id=' + id;
            });
            ...
            $('#searchBox').on('submit', function(e) {
                ...
                $("#pagination").empty();
                $.ajax({
                    url: 'data/scripts/requestbase.php?req=searchOffers',
                    type: 'POST',
                    data: {
                        page: page,
            ...
            $('#tableBody').on('click', '#deleteBtn', function() {
                var id = $(this).data('id');
                var currentPage = $('select#pagination').val();
                if (confirm("Are you sure to delete this row?")) {
                    $.ajax({
                        url: 'data/scripts/requestbase.php?req=deleteOffer',
                        type: 'POST',
                        data: {
                            id: id,
                        },
