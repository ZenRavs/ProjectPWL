...
if (isset($_SESSION['user'])) {
    ...
    $page = $_GET['page'] ?? 0;
?>
    <div class="row g-3 mb-3 me-1">
        <div class="col-sm-6 justify-content-start">
            <div class="row g-3 input-group">
                <form class="col input-group" id="searchBox">
                    <select class="form-select" id="searchCategory" title="Select the searching categories...">
                        <option value="name">Name</option>
                        <option value="nim">NIM</option>
                        <option value="email">Email</option>
                    </select>
                    <input type="text" class="form-control" id="searchInput" placeholder="Search..." aria-label="Search" style="width: 290px;" title="Search for Name, NIM, or Email." required>
        ...
        <div class="col-sm-1">
            <a type="button" href="data/scripts/reporting/mpdfMhs.php" class="btn btn-dark">&#128462; Print</a>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-2 justify-content-end align-center">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <select class="form-select" id="pageOption"></select>
                </div>
    ...
    <table class="table table-dark table-hover">
        <thead>
            <tr>
                ...
                <th class="text-center">User Picture</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData(page, maxRow) {
                $("#tableBody").empty();
                $.ajax({
                    url: 'data/scripts/requestbase.php?req=fetchStudents',
                    type: 'POST',
                    data: {
                        page: page,
                        maxRow: maxRow
            ...
            $('#searchBox').on('submit', function(e) {
                ...
                $("#pageOption").empty();
                $.ajax({
                    url: 'data/scripts/requestbase.php?req=searchStudent',
                    type: 'POST',
                    data: {
                        page: page,
            ...
            $('#tableBody').on('click', '#deleteBtn', function() {
                ...
                if (confirm("Are you sure to delete this row?")) {
                    $.ajax({
                        url: 'data/scripts/requestbase.php?req=deleteStudent',
                        type: 'POST',
                        data: {
                            id: id,
                            page: page
